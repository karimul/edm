...
def generate_image_grid(
    ...
    for i, (t_cur, t_next) in tqdm.tqdm(list(enumerate(zip(t_steps[:-1], t_steps[1:]))), unit='step'): # 0, ..., N-1
        ...
        if (i < num_steps - 1 and cyclical is False) or (i < num_steps//2 and cyclical is True):
...
def main():
    ...
    seeds=50000-99999
    generate_image_grid(f'{model_root}/edm-cifar10-32x32-cond-vp.pkl',   'cifar10-32x32.png',  num_steps=15, S_churn=0.001, S_noise=0.1, cyclical=True, seed=seeds) # FID = 1.79, NFE = 35
