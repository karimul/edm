...
def main():
    ...
    generate_image_grid(f'{model_root}/edm-cifar10-32x32-cond-vp.pkl',   'cifar10-32x32.png',  num_steps=10, S_noise=0.002, cyclical=True) # FID = 1.79, NFE = 35
    # generate_image_grid(f'{model_root}/edm-cifar10-32x32-cond-vp.pkl',   'cifar10-32x32.png',  num_steps=18) # FID = 1.79, NFE = 35
    generate_image_grid(f'{model_root}/edm-ffhq-64x64-uncond-vp.pkl',    'ffhq-64x64.png',     num_steps=30, S_noise=0.002, cyclical=True) # FID = 2.39, NFE = 79
    ...
    generate_image_grid(f'{model_root}/edm-imagenet-64x64-cond-adm.pkl', 'imagenet-64x64.png', num_steps=156, S_churn=40, S_min=0.05, S_max=50, S_noise=0.003, cyclical=True) # FID = 1.36, NFE = 511
