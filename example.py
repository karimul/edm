...
def main():
    ...
    seeds=50000-99999
    generate_image_grid(f'{model_root}/edm-cifar10-32x32-cond-vp.pkl',   'cifar10-32x32.png',  num_steps=18, S_churn=1, S_noise=0.001, cyclical=True, seed=seeds, sigma_max=50) # FID = 1.79, NFE = 35
