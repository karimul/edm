...
def main():
    ...
    seeds=50000-99999
    generate_image_grid(f'{model_root}/edm-cifar10-32x32-cond-vp.pkl',   'cifar10-32x32.png',  num_steps=16, S_churn=0.001, S_noise=0.1, cyclical=True, seed=seeds) # FID = 1.79, NFE = 35
