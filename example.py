...
def main():
    ...
    seeds=50000-99999
    generate_image_grid(f'{model_root}/edm-cifar10-32x32-cond-vp.pkl',   'cifar10-32x32.png',  num_steps=18, S_churn=0.00001, S_noise=1, cyclical=True, seed=seeds) # FID = 1.79, NFE = 35
